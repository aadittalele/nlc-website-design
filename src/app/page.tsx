...
export default function Home() {
  return (
    <main className="overflow-hidden">
      ...
      <div className="bg-[#13300e] pt-8 text-white text-center">
      ...
      <Image width={500} height={40} className="w-full bg-[#e9f5ea]" src="/invert.svg" alt="inverted curve"/>
      <div className="py-12 px-8 text-center bg-[#e9f5ea]">
        <FadeInView y={100}>
          <div className="flex flex-col md:flex-row">
            <div className="w-full md:w-1/3 mx-2 md:mx-6 rounded-2xl shadow-xl mb-12 bg-white hover:bg-green-600 text-gray-700 hover:text-white transition-all">
              <Image
                alt="windmills"
                src="/windmills.webp"
              ...
              <p className="font-extrabold leading-none text-3xl">
                Donate
              </p>
              <p className="p-6">
            ...
            <div className="w-full md:w-1/3 mx-2 md:mx-6 rounded-2xl shadow-xl mb-12 bg-white hover:bg-blue-600 text-gray-700 hover:text-white transition-all">
              <Image
                alt="coast"
                src="/coast.jpg"
            ...
            <div className="w-full md:w-1/3 mx-2 md:mx-6 rounded-2xl shadow-xl mb-12 bg-white hover:bg-[#A4B509] text-gray-700 hover:text-white transition-all">
              <Image
                alt="gala"
                src="/gala.jpg"
                className="rounded-t-2xl w-full h-64 object-cover origin-top"
