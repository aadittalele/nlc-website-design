...
export default function Sources() {
  return (
    <div>
      ...
      <div className="mx-4 sm:mx-12 md:mx-32 my-12 mb-[45vh]">
        <div className="mb-8">
          <p>
            <b>[1]</b>{" "}
            <i>
              Environment, U. (n.d.). Deforestation. UNEP.{" "}
              <a className="underline" href="https://www.unep.org/resources/factsheet/deforestation">
                https://www.unep.org/resources/factsheet
                /deforestation
              </a>
            </i>
          </p>
          <p>
            ...
            <i>
              ...
              <a className="underline" href="https://sustainability.georgetown.edu/50-facts-for-50-years/">
          ...
          <p>
            ...
            <i>
              ...
              <a className="underline" href="https://climate.nasa.gov/evidence/">https://climate.nasa.gov/evidence/</a>
            </i>
          </p>
        </div>
        <div>
          <div>
            <p>Home Page Earth Texture: January, Blue Marble Next Generation w/ Topography and Bathymetry from <a className="underline" href="https://visibleearth.nasa.gov/images/73580/january-blue-marble-next-generation-w-topography-and-bathymetry">NASA Visible Earth</a></p>
          </div>
          <div>
          ...
          <div>
            <a className="underline" href="https://unsplash.com/photos/green-leaf-tree-under-blue-sky-tGTVxeOr_Rs">Big Tree Image</a>
          </div>
          <div>
            <a className="underline" href="https://fonts.google.com/icons">Google Fonts Icons</a>
          </div>
        </div>
      </div>
    </div>
