  ...
  return (
    <div className="bg-[#F6F6F6] mx-4 sm:mx-auto">
      <div className="relative overflow-hidden py-10 md:px-4">
        ...
        <FadeInView x={1000} margin="0px 0px">
          <div className="mb-8 flex justify-between items-center w-full">
            <div className="order-1 w-5/12"></div>
            <div className="z-20 flex items-center order-1 bg-blue-800 shadow-xl w-8 h-8 rounded-full">
              <h1 className="mx-auto font-semibold text-lg text-white">1</h1>
            </div>
            <div className="order-1 w-5/12 px-8 py-4">
              <h3 className="mb-2 font-bold text-gray-800 text-3xl">Welcome Reception</h3>
        ...
        <FadeInView x={-1000} margin="-30% 0px">
          <div className="mb-8 flex justify-between flex-row-reverse items-center w-full">
            ...
            <div className="order-1 w-5/12 px-2 sm:px-14 py-4 text-end">
              <h3 className="mb-2 font-bold text-gray-800 text-3xl">Opening Remarks</h3>
        ...
        <FadeInView x={1000} margin="-30% 0px">
          <div className="mb-8 flex justify-between items-center w-full right-timeline">
            ...
            <div className="order-1 w-5/12 px-2 sm:px-14 py-4">
              <h3 className="mb-2 font-bold text-gray-800 text-3xl">Dinner Service</h3>
        ...
        <FadeInView x={-1000} margin="-30% 0px">
          <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div className="order-1 w-5/12 px-2 sm:px-14 py-4 text-end">
              <h3 className="mb-2 font-bold text-gray-800 text-3xl">Keynote Speaker</h3>
        ...
        <FadeInView x={1000} margin="-30% 0px">
          <div className="mb-8 flex justify-between items-center w-full right-timeline">
            ...
            <div className="order-1 w-5/12 px-2 sm:px-14 py-4">
              <h3 className="mb-2 font-bold text-gray-800 text-3xl">Awards Ceremony</h3>
        ...
        <FadeInView x={-1000} margin="-30% 0px">
          <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div className="order-1 w-5/12 px-2 sm:px-14 py-4 text-end">
              <h3 className="mb-2 font-bold text-gray-800 text-3xl">Closing and Networking</h3>
